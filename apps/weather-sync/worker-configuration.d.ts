/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 5640b6c4dbd93aeb9e771b4a1b2b60f2)
// Runtime types generated with workerd@1.20260714.1 2026-07-21 
interface __BaseEnv_Env {
	F1_DB: D1Database;
	CLOUDFLARE_ZONE_NAME: "f1-box.com";
	WEATHER_CONTAINER: DurableObjectNamespace<import("./src/index").WeatherContainer>;
	WEATHER_SYNC: Workflow<Parameters<import("./src/index").WeatherSyncWorkflow['run']>[0]['payload']>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "WeatherContainer";
	}
